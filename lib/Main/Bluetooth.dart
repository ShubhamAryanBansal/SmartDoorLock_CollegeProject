      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              'Your Phone Blutooth is ${state != null ? state.toString().substring(15) : 'not on. Kindly turn on the phone bluetoooth to connect the device.'}.',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        padding: EdgeInsets.only(top:20,left: 20,right: 20),
        child:
              Image.asset('assets/intro/unlock.png'))),
            StreamBuilder<BluetoothDeviceState>(
              stream: device.state,
              initialData: BluetoothDeviceState.connecting,
